...
export default function Eventos() {
    ...
    const [comics1, setEventos] = useState([]);
    ...
    const obtenerEventos = () => {
        ...
        */
        axios.get("https://gateway.marvel.com/v1/public/comics?ts=1&apikey=c1900eb52930ed1b7ce840e189c99d54&hash=5781e9271c1ff2dab15c638283e5727f").then((response) => {
                            ...
                            <div className='col-md-4 mt-4' key={indice}>
                                <div className='card'>
                                    ...
                                    <div className='card-body'>
                                        ...
                                        <h2>serie:{evento.series.name}</h2>
